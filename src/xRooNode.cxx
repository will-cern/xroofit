...
//                }
    ...
    } else if(auto p = get<RooAbsPdf>(); p && !(fParent && fParent->get<RooRealSumPdf>())) {
    ...
    } else if(auto p = get<RooAbsReal>(); p && (!get<RooAbsPdf>() || (fParent && fParent->get<RooRealSumPdf>()))) {
